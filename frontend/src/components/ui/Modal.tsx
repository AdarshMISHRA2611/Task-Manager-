  ...
  return createPortal(
    ...
    >
      <div
        ...
        aria-modal="true"
        className={clsx(
          "relative w-full overflow-hidden rounded-2xl bg-surface shadow-2xl ring-1 ring-border",
          SIZE[size]
        )}
      >
        {(title || description) && (
          <div className="flex items-start justify-between gap-4 border-b border-border px-6 py-4">
            ...
            <button
              ...
              aria-label="Close"
              onClick={onClose}
              className="-mr-2 shrink-0 rounded-lg p-2 text-muted-foreground hover:bg-surface-muted hover:text-foreground focus-ring"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
